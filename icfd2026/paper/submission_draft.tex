...
This study aims to develop a reaction mechanism that can accurately model the LBV of NH3/air, NH3/CH4/air and
...
For Okafor Reduced Mech, IROPs are then normalized with respect to the IROP of the OH$\rightarrow$H2O pathway,
...
The three observations from Fig. \ref{fig-gotama_reac-path} depict the importance N2Hx species and their reaction
